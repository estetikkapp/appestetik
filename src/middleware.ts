...
const PUBLIC_PREFIXES = ['/auth', '/c/', '/embed/', '/turno/', '/agente', '/precios', '/inicio', '/ayuda', '/api/public', '/api/slots', '/api/cron', '/api/whatsapp/webhook', '/api/whatsapp/cloud-webhook', '/api/webhooks'];
