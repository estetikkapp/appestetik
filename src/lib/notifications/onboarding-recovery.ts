...
function template1(p: RecoveryEmailParams): RecoveryTemplate {
  ...
  const subject = '¿Te trabaste con appestetika?';
...
<p style="margin:0 0 12px;font-size:15px;color:#57534e;line-height:1.6;">Vimos que ayer creaste tu cuenta en appestetika pero no llegaste a terminar el setup. Pasa, todo bien.</p>
...
<a href="${APP_URL}/onboarding" style="display:inline-block;background:#a85f58;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px;padding:14px 32px;border-radius:10px;">Retomar el setup</a>
</td></tr>
...
Retomar el setup: ${APP_URL}/onboarding
